...
.method public static parse(Ljava/lang/String;Ljava/text/ParsePosition;)Ljava/util/Date;
    ...
    if-le v12, v8, :cond_9b

    const/16 v8, 0x3f

    if-ge v12, v8, :cond_9b
    ...
    if-eq v15, v14, :cond_10d

    const/16 v14, 0x2d

    if-ne v15, v14, :cond_f6
    ...
    throw v0
    :try_end_1c5
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_a .. :try_end_1c5} :catch_1c9
    .catch Ljava/lang/NumberFormatException; {:try_start_a .. :try_end_1c5} :catch_1c7
    .catch Ljava/lang/IllegalArgumentException; {:try_start_a .. :try_end_1c5} :catch_1c5
