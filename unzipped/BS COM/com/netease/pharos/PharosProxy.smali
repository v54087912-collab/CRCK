...
.method private parseConfig(Lorg/json/JSONObject;)V
    ...
    .line 646
    invoke-virtual {p0, v2}, Lcom/netease/pharos/PharosProxy;->setmIp(Ljava/lang/String;)V
    ...
    :try_end_4f
    .catch Lorg/json/JSONException; {:try_start_3f .. :try_end_4f} :catch_50
    ...
    .line 658
    :goto_55
    invoke-virtual {p0, v4}, Lcom/netease/pharos/PharosProxy;->setmPort(Ljava/lang/String;)V
    ...
    .line 668
    :try_start_6f
    invoke-virtual {v6, v3}, Lorg/json/JSONArray;->getLong(I)J
    :try_end_72
    .catch Ljava/lang/Exception; {:try_start_6f .. :try_end_72} :catch_75
    ...
    .line 675
    :goto_7c
    invoke-virtual {p0, v8}, Lcom/netease/pharos/PharosProxy;->setmPorts(Lorg/json/JSONArray;)V
    ...
    .line 682
    invoke-virtual {p0, v8}, Lcom/netease/pharos/PharosProxy;->setmHighSpeedUrl(Ljava/lang/String;)V
    ...
    .line 688
    invoke-virtual {p0, v5}, Lcom/netease/pharos/PharosProxy;->setmQosIp(Ljava/lang/String;)V

    .line 692
    :cond_a2
    const-string/jumbo v9, "testlog"

    invoke-virtual {p1, v9, v3}, Lorg/json/JSONObject;->optInt(Ljava/lang/String;I)I

    move-result v3

    iput v3, p0, Lcom/netease/pharos/PharosProxy;->mTestLog:I

    .line 693
    const-string v3, "harborudp"
    ...
    .line 695
    invoke-virtual {p0, v3}, Lcom/netease/pharos/PharosProxy;->setmHarborudp(Ljava/lang/String;)V
    ...
    iput-object v3, p0, Lcom/netease/pharos/PharosProxy;->mLagID:Ljava/lang/String;
    ...
    invoke-static {v3}, Lcom/netease/pharos/util/LogUtil;->setIsShowLog(Z)V

    .line 707
    :cond_f3
    const-string v3, "ipv6_verify"
    ...
    .line 709
    const-string v3, "callback_policy"
    ...
    .line 711
    invoke-virtual {p0, v3}, Lcom/netease/pharos/PharosProxy;->setCallbackPolicy(Ljava/lang/String;)V
    ...
    iput v3, p0, Lcom/netease/pharos/PharosProxy;->mArea:I

    const/16 v3, 0x708

    .line 715
    :try_start_117
    sget-object v7, Lcom/netease/pharos/Const;->CACHE_EXPIRE:Ljava/util/concurrent/atomic/AtomicInteger;

    const-string v10, "cache_expire"

    invoke-virtual {p1, v10, v3}, Lorg/json/JSONObject;->optInt(Ljava/lang/String;I)I
    ...
    invoke-static {v9, v7}, Lcom/netease/pharos/util/LogUtil;->i(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_13c
    .catch Ljava/lang/Exception; {:try_start_117 .. :try_end_13c} :catch_13d
    ...
    const-string v3, "PharosProxy [pharosFunc] ip ="
...
.method private startPolicyTask()V
    ...
    .line 450
    const-string/jumbo v0, "网络监控----设备探测"
    ...
    const-string/jumbo v4, "网络监控----设备探测，结果="
    ...
    invoke-virtual {v4, v2}, Lcom/netease/pharos/deviceCheck/DeviceInfo;->getDeviceInfo(Z)Ljava/lang/String;
    ...
    .line 459
    const-string/jumbo v3, "网络监控----区域决策"
    ...
    const-string/jumbo v5, "网络监控----区域决策，结果="
    ...
    invoke-virtual {v5, v2}, Lcom/netease/pharos/deviceCheck/DeviceInfo;->getDeviceInfo(Z)Ljava/lang/String;
    ...
    const-string/jumbo v4, "网络监控----区域决策，返回码="
    ...
    invoke-virtual {v2}, Lcom/netease/pharos/linkcheck/Proxy;->getCallBackInfo()Lorg/json/JSONObject;
    ...
    .line 478
    invoke-virtual {v0, v2}, Lcom/netease/pharos/PharosListener;->onPharosPolicy(Lorg/json/JSONObject;)V

    .line 482
    :cond_c7
    const-string/jumbo v0, "网络监控----链路探测"
    ...
    .line 484
    const-string/jumbo v0, "网络监控----链路探测，结束"
...
.method public declared-synchronized pharosFunc(Lorg/json/JSONObject;)V
    ...
    const-string v0, "PharosProxy [pharosFunc] paramJson ="
...
.method public pharosLoginInfoUpload(Lorg/json/JSONObject;)V
    ...
    .line 0
    const-string v7, "PharosProxy [pharosLoginInfoUpload] deviceInfoJson="
    ...
    invoke-virtual {v8, v10}, Lcom/netease/pharos/deviceCheck/DeviceInfo;->getDeviceInfo(Z)Ljava/lang/String;
    ...
    .line 890
    const-string v10, "PharosProxy [pharosLoginInfoUpload] deviceInfo1 error"
    ...
    move-result v7
    :try_end_52
    .catch Ljava/lang/Exception; {:try_start_26 .. :try_end_52} :catch_c1
    ...
    :try_end_c0
    .catch Ljava/lang/Exception; {:try_start_56 .. :try_end_c0} :catch_c1
...
.method public pharosqosexec(Lorg/json/JSONArray;J)V
    ...
    .line 792
    const-string v0, "PharosProxy [pharosqosexec]"
...
.method public pharosqosstatus(Lorg/json/JSONArray;)V
    ...
    .line 828
    const-string v0, "PharosProxy [pharosqosstatus]"
...
.method public registerReceiver(Landroid/content/Context;)V
    ...
    .line 113
    const-string/jumbo v0, "注册网络广播监听器 start"
    ...
    .line 114
    iget-boolean v0, p0, Lcom/netease/pharos/PharosProxy;->mIsRegistered:Z
    ...
    .line 117
    const-string/jumbo p1, "注册网络广播监听器失败"
    ...
    .line 129
    new-instance v0, Lcom/netease/pharos/PharosProxy$1;

    invoke-direct {v0, p0}, Lcom/netease/pharos/PharosProxy$1;-><init>(Lcom/netease/pharos/PharosProxy;)V

    .line 162
    invoke-static {p1, v0}, Lcom/netease/ntunisdk/SdkCommon$$ExternalSyntheticApiModelOutline0;->m(Landroid/net/ConnectivityManager;Landroid/net/ConnectivityManager$NetworkCallback;)V
    :try_end_47
    ...
    .line 170
    :cond_5b
    const-string/jumbo p1, "已经注册过网络广播监听器，无需重复注册"
...
.method public unregisterReceiver()V
    ...
    const-string/jumbo v1, "注销网络广播监听器"
