...
.method public static OooO00o(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v4, "source length:"
    ...
    move-result v0
    :try_end_5c
    .catch Ljava/lang/Exception; {:try_start_51 .. :try_end_5c} :catch_2a3
    ...
    move-result-object v0
    :try_end_8d
    .catch Ljava/lang/Exception; {:try_start_65 .. :try_end_8d} :catch_2a3
    ...
    :try_end_97
    .catch Ljava/lang/Exception; {:try_start_8f .. :try_end_97} :catch_1fb
    ...
    move-result v14
    :try_end_a1
    .catch Ljava/lang/Exception; {:try_start_97 .. :try_end_a1} :catch_1f1
    ...
    move-result v0
    :try_end_cd
    .catch Ljava/lang/Exception; {:try_start_ab .. :try_end_cd} :catch_149
    ...
    sget-object v1, Lcom/netease/environment/OooO0O0/OooO0OO;->OooO00o:Ljava/lang/String;
    :try_end_d9
    .catch Ljava/lang/Exception; {:try_start_cf .. :try_end_d9} :catch_12d
    ...
    :try_end_e0
    .catch Ljava/lang/Exception; {:try_start_db .. :try_end_e0} :catch_12b
    ...
    if-le v12, v0, :cond_111

    if-lt v9, v12, :cond_111
    ...
    move-result-object v0
    :try_end_11d
    .catch Ljava/lang/Exception; {:try_start_e2 .. :try_end_11d} :catch_129
    ...
    move-result v3
    :try_end_164
    .catch Ljava/lang/Exception; {:try_start_15b .. :try_end_164} :catch_1ed
    ...
    :try_end_19c
    .catch Ljava/lang/Exception; {:try_start_166 .. :try_end_19c} :catch_1bd

    if-ltz v1, :cond_1aa

    if-le v3, v1, :cond_1aa

    if-lt v9, v3, :cond_1aa
    ...
    aput v0, v10, v1
    :try_end_1a7
    .catch Ljava/lang/Exception; {:try_start_1a5 .. :try_end_1a7} :catch_129
    ...
    move-result v0
    :try_end_1ae
    .catch Ljava/lang/Exception; {:try_start_1aa .. :try_end_1ae} :catch_1bd
    ...
    move-result-object v0
    :try_end_1b6
    .catch Ljava/lang/Exception; {:try_start_1b2 .. :try_end_1b6} :catch_1b7
    ...
    :try_end_1ce
    .catch Ljava/lang/Exception; {:try_start_1cb .. :try_end_1ce} :catch_1dc
    ...
    .line 130
    invoke-static {v2, v0, v8, v1}, Lcom/netease/environment/OooO0oo/OooO0oO;->OooO00o(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0
    :try_end_2a2
    .catch Ljava/lang/Exception; {:try_start_203 .. :try_end_2a2} :catch_2a3
