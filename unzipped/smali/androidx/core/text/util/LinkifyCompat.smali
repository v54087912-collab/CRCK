...
.method public static addLinks(Landroid/text/Spannable;I)Z
    ...
    const-string v2, "060419111D5B484A"
    ...
    const-string v5, "06041911544E48"
    ...
    const-string v2, "0311040D1A0E5D"
...
.method private static gatherMapLinks(Ljava/util/ArrayList;Landroid/text/Spannable;)V
    ...
    move-result-object p1
    :try_end_26
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_5 .. :try_end_26} :catch_4b

    :try_start_26
    const-string v2, "3B242B4C56"
    ...
    move-result-object v1
    :try_end_30
    .catch Ljava/io/UnsupportedEncodingException; {:try_start_26 .. :try_end_30} :catch_5
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_26 .. :try_end_30} :catch_4b
    ...
    const-string v4, "0915025B5E4D575A0353"
    ...
    invoke-virtual {p0, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z
    :try_end_4a
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_30 .. :try_end_4a} :catch_4b
