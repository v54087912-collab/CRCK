...
.method private final filterPurchases(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    :try_end_2a
    .catchall {:try_start_8 .. :try_end_2a} :catchall_66
    ...
    :try_end_61
    .catch Lorg/json/JSONException; {:try_start_2a .. :try_end_61} :catch_1e
...
.method private final getMethod(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/reflect/Method;
    ...
    move-result v0
    :try_end_17
    .catchall {:try_start_8 .. :try_end_17} :catchall_d7
    ...
    invoke-interface {v0, p2, p1}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_d6
    .catchall {:try_start_23 .. :try_end_d6} :catchall_d7
    ...
    :sswitch_data_dc
    .sparse-switch
        -0x6b5af324 -> :sswitch_93
        -0x5677d643 -> :sswitch_78
        -0x42f2e6d9 -> :sswitch_68
        -0x236d29e3 -> :sswitch_44
        -0x222c05a5 -> :sswitch_23
    .end sparse-switch
.end method
...
.method private final getPurchaseHistory(Landroid/content/Context;Ljava/lang/Object;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    :try_end_6e
    .catchall {:try_start_8 .. :try_end_6e} :catchall_9c
    ...
    :try_end_86
    .catch Lorg/json/JSONException; {:try_start_6e .. :try_end_86} :catch_62
    .catchall {:try_start_6e .. :try_end_86} :catchall_9c
...
.method private final getPurchases(Landroid/content/Context;Ljava/lang/Object;Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    move-result-object v3
    :try_end_5c
    .catchall {:try_start_8 .. :try_end_5c} :catchall_65
...
.method private final getSkuDetailsFromGoogle(Landroid/content/Context;Ljava/util/ArrayList;Ljava/lang/Object;Z)Ljava/util/Map;
    ...
    :try_end_8f
    .catchall {:try_start_8 .. :try_end_8f} :catchall_90
...
.method private final readSkuDetailsFromCache(Ljava/util/ArrayList;)Ljava/util/Map;
    ...
    :try_end_60
    .catchall {:try_start_8 .. :try_end_60} :catchall_62
...
.method public final hasFreeTrialPeirod(Ljava/lang/String;)Z
    ...
    move-result p1
    :try_end_21
    .catch Lorg/json/JSONException; {:try_start_d .. :try_end_21} :catch_2b
