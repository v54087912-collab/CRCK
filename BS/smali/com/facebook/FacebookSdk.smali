...
.method public static final getApplicationSignature(Landroid/content/Context;)Ljava/lang/String;
    ...
    :try_end_1d
    .catchall {:try_start_a .. :try_end_1d} :catchall_4e
    ...
    move-result-object p0
    :try_end_23
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_1f .. :try_end_23} :catch_4d
    .catchall {:try_start_1f .. :try_end_23} :catchall_4e
    ...
    array-length v1, v1
    :try_end_28
    .catchall {:try_start_23 .. :try_end_28} :catchall_4e
    ...
    move-result-object v1
    :try_end_37
    .catch Ljava/security/NoSuchAlgorithmException; {:try_start_31 .. :try_end_37} :catch_4d
...
.method public static final loadDefaultsFromMetadata$facebook_core_release(Landroid/content/Context;)V
    ...
    move-result-object p0
    :try_end_11
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_3 .. :try_end_11} :catch_b9
...
.method private final publishInstallAndWaitForResponse(Landroid/content/Context;Ljava/lang/String;)V
    ...
    move-result-wide v6
    :try_end_20
    .catch Ljava/lang/Exception; {:try_start_7 .. :try_end_20} :catch_7a
    ...
    :try_end_32
    .catch Lorg/json/JSONException; {:try_start_20 .. :try_end_32} :catch_6d
    .catch Ljava/lang/Exception; {:try_start_20 .. :try_end_32} :catch_7a
    .catchall {:try_start_20 .. :try_end_32} :catchall_78
    ...
    throw p2
    :try_end_78
    .catch Ljava/lang/Exception; {:try_start_32 .. :try_end_78} :catch_7a
    .catchall {:try_start_32 .. :try_end_78} :catchall_78
...
.method public static final declared-synchronized sdkInitialize(Landroid/content/Context;Lcom/facebook/FacebookSdk$InitializeCallback;)V
    ...
    :try_end_16
    .catchall {:try_start_3 .. :try_end_16} :catchall_11b
    ...
    :try_end_f7
    .catchall {:try_start_18 .. :try_end_f7} :catchall_11b
    ...
    throw v2
    :try_end_11b
    .catchall {:try_start_f9 .. :try_end_11b} :catchall_11b
...
.method public static final setDataProcessingOptions([Ljava/lang/String;II)V
    ...
    throw p0
    :try_end_5b
    .catch Lorg/json/JSONException; {:try_start_13 .. :try_end_5b} :catch_5e
    .catchall {:try_start_13 .. :try_end_5b} :catchall_11
