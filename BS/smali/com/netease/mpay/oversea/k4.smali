...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/netease/mpay/oversea/k4$j;,
        Lcom/netease/mpay/oversea/k4$k;,
        Lcom/netease/mpay/oversea/k4$l;
    }
.end annotation


# instance fields
.field private a:Lcom/netease/mpay/oversea/k4$j;
...
.method static synthetic a(Lcom/netease/mpay/oversea/k4;)Lcom/netease/mpay/oversea/k4$j;
    .registers 1

    .line 1
    iget-object p0, p0, Lcom/netease/mpay/oversea/k4;->a:Lcom/netease/mpay/oversea/k4$j;
...
# virtual methods
.method public a(Lcom/netease/mpay/oversea/k4$j;)Lcom/netease/mpay/oversea/k4;
    .registers 2

    .line 2
    iput-object p1, p0, Lcom/netease/mpay/oversea/k4;->a:Lcom/netease/mpay/oversea/k4$j;

    return-object p0
.end method

.method public a(Landroid/app/Activity;Lcom/netease/mpay/oversea/k4$l;)V
    .registers 15
    ...
    .line 7
    new-instance v2, Lcom/netease/mpay/oversea/k4$a;

    invoke-direct {v2, p0, p2}, Lcom/netease/mpay/oversea/k4$a;-><init>(Lcom/netease/mpay/oversea/k4;Lcom/netease/mpay/oversea/k4$l;)V
    ...
    .line 18
    invoke-static {v3}, Lcom/netease/mpay/oversea/ac;->a(Landroid/view/Window;)V

    .line 20
    :try_start_2a
    invoke-virtual {v0}, Landroid/app/AlertDialog;->show()V
    :try_end_2d
    .catch Landroid/view/WindowManager$BadTokenException; {:try_start_2a .. :try_end_2d} :catch_152
    .catch Ljava/lang/Exception; {:try_start_2a .. :try_end_2d} :catch_14e
    ...
    invoke-virtual {v8}, Lcom/netease/mpay/oversea/d9;->f()Z
    ...
    .line 31
    invoke-static {v4, v8}, Lcom/netease/mpay/oversea/ac;->a(Landroid/view/View;I)V
    ...
    .line 41
    invoke-static {v3}, Lcom/netease/mpay/oversea/ac;->b(Landroid/view/Window;)V

    .line 43
    :cond_7f
    invoke-static {v3}, Lcom/netease/mpay/oversea/ac;->d(Landroid/view/Window;)V

    .line 45
    :cond_82
    iget-object v3, p0, Lcom/netease/mpay/oversea/k4;->a:Lcom/netease/mpay/oversea/k4$j;

    invoke-virtual {v3, v0}, Lcom/netease/mpay/oversea/k4$j;->a(Landroid/app/Dialog;)Lcom/netease/mpay/oversea/k4$j;
    ...
    invoke-static {v11, v7}, Lcom/netease/mpay/oversea/ac;->a(Landroid/graphics/drawable/Drawable;Landroid/view/View;)V
    ...
    invoke-static {v11, v8}, Lcom/netease/mpay/oversea/ac;->a(Landroid/graphics/drawable/Drawable;Landroid/view/View;)V

    .line 56
    sget v11, Lcom/netease/mpay/oversea/R$string;->netease_mpay_oversea__login_guest_switch_tips:I

    invoke-static {p1, v11}, Lcom/netease/mpay/oversea/f8;->a(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :try_end_f8
    .catchall {:try_start_f1 .. :try_end_f8} :catchall_f8
    ...
    .line 72
    new-instance v1, Lcom/netease/mpay/oversea/k4$b;

    invoke-direct {v1, p0, v9}, Lcom/netease/mpay/oversea/k4$b;-><init>(Lcom/netease/mpay/oversea/k4;Landroid/widget/EditText;)V

    invoke-virtual {v4, v1}, Landroid/widget/TextView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 80
    new-instance v1, Lcom/netease/mpay/oversea/k4$c;

    invoke-direct {v1, p0, v9}, Lcom/netease/mpay/oversea/k4$c;-><init>(Lcom/netease/mpay/oversea/k4;Landroid/widget/EditText;)V
    ...
    .line 91
    new-instance v1, Lcom/netease/mpay/oversea/k4$d;

    invoke-direct {v1, p0, p2, v0, p1}, Lcom/netease/mpay/oversea/k4$d;-><init>(Lcom/netease/mpay/oversea/k4;Lcom/netease/mpay/oversea/k4$l;Landroid/app/AlertDialog;Landroid/app/Activity;)V

    invoke-virtual {v6, v1}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 102
    new-instance v1, Lcom/netease/mpay/oversea/k4$e;

    invoke-direct {v1, p0, v4, v7}, Lcom/netease/mpay/oversea/k4$e;-><init>(Lcom/netease/mpay/oversea/k4;Landroid/widget/TextView;Landroid/widget/TextView;)V

    invoke-virtual {v9, v1}, Landroid/widget/EditText;->addTextChangedListener(Landroid/text/TextWatcher;)V

    .line 131
    new-instance v1, Lcom/netease/mpay/oversea/k4$f;

    invoke-direct {v1, p0, p1}, Lcom/netease/mpay/oversea/k4$f;-><init>(Lcom/netease/mpay/oversea/k4;Landroid/app/Activity;)V

    invoke-virtual {v9, v1}, Landroid/widget/EditText;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 137
    new-instance v1, Lcom/netease/mpay/oversea/k4$g;

    invoke-direct {v1, p0, p1}, Lcom/netease/mpay/oversea/k4$g;-><init>(Lcom/netease/mpay/oversea/k4;Landroid/app/Activity;)V

    invoke-virtual {v9, v1}, Landroid/widget/EditText;->setOnFocusChangeListener(Landroid/view/View$OnFocusChangeListener;)V

    .line 145
    new-instance v1, Lcom/netease/mpay/oversea/k4$h;

    invoke-direct {v1, p0, p2, v0, p1}, Lcom/netease/mpay/oversea/k4$h;-><init>(Lcom/netease/mpay/oversea/k4;Lcom/netease/mpay/oversea/k4$l;Landroid/app/AlertDialog;Landroid/app/Activity;)V

    invoke-virtual {v8, v1}, Landroid/widget/TextView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 156
    new-instance v0, Lcom/netease/mpay/oversea/k4$i;

    invoke-direct {v0, p0, v9, p2, p1}, Lcom/netease/mpay/oversea/k4$i;-><init>(Lcom/netease/mpay/oversea/k4;Landroid/widget/EditText;Lcom/netease/mpay/oversea/k4$l;Landroid/app/Activity;)V
