...
.method private chooseIp()Z
    ...
    const-string/jumbo v3, "， 所选择的host="
...
.method private correctIp()Z
    ...
    const-string/jumbo v1, "没有其他ip可切换，删除该host ,part="
...
.method private downloadPart(Lcom/netease/download/downloader/DownloadParams;)I
    ...
    iget-object v7, v0, Lcom/netease/download/downloadpart/DownloadPartCore;->tmpFilePath:Ljava/lang/String;
    ...
    .line 576
    invoke-direct {v0, v7, v1}, Lcom/netease/download/downloadpart/DownloadPartCore;->checkPartCoreFile(Ljava/io/File;Lcom/netease/download/downloader/DownloadParams;)I

    move-result v8

    .line 577
    invoke-direct {v0, v7, v8, v1}, Lcom/netease/download/downloadpart/DownloadPartCore;->handlePartCoreFile(Ljava/io/File;ILcom/netease/download/downloader/DownloadParams;)I
    ...
    .line 584
    invoke-direct {v0, v5, v7, v8, v1}, Lcom/netease/download/downloadpart/DownloadPartCore;->handlePartTempFile(Ljava/io/File;Ljava/io/File;ILcom/netease/download/downloader/DownloadParams;)I
    ...
    iput-object v7, v0, Lcom/netease/download/downloadpart/DownloadPartCore;->mHeader:Ljava/util/Map;
    ...
    invoke-virtual {v7, v8}, Lcom/netease/ntunisdk/okhttp3/Request$Builder;->url(Ljava/lang/String;)Lcom/netease/ntunisdk/okhttp3/Request$Builder;
    ...
    const-string/jumbo v8, "， 之前下载好的文件的大小="
    ...
    invoke-virtual {v7, v5, v2}, Lcom/netease/ntunisdk/okhttp3/Request$Builder;->addHeader(Ljava/lang/String;Ljava/lang/String;)Lcom/netease/ntunisdk/okhttp3/Request$Builder;
    ...
    invoke-direct {v0, v7, v2}, Lcom/netease/download/downloadpart/DownloadPartCore;->enterDonwload(Lcom/netease/ntunisdk/okhttp3/Request$Builder;Ljava/util/Map;)I
    ...
    iget-object v7, v0, Lcom/netease/download/downloadpart/DownloadPartCore;->mHost:Ljava/lang/String;

    invoke-virtual {v5, v7}, Lcom/netease/download/dns/CdnUseTimeProxy;->finish(Ljava/lang/String;)V
    ...
    iget-object v7, v0, Lcom/netease/download/downloadpart/DownloadPartCore;->mIp:Ljava/lang/String;
    ...
    const-string/jumbo v7, "， 进入【重新选择下一个可用ip环节】"
    ...
    const-string v7, "[ORBIT] Removed Ip="
    ...
    const-string v7, " Speed=1 Timeout=1"
    ...
    const-string/jumbo v8, "，hasReloadCondition="
    ...
    const-string/jumbo v5, "进入【重新选择下一个可用ip环节】 ， 进入重试"
    ...
    .line 664
    iput-boolean v6, v0, Lcom/netease/download/downloadpart/DownloadPartCore;->mRestart:Z
    ...
    const-string/jumbo v5, "进入【httpdns处理】环节 ， 进入重试"
    ...
    const-string/jumbo v5, "， 进入【使用历史记录最高速ip】环节"
    ...
    .line 676
    iput-boolean v6, v0, Lcom/netease/download/downloadpart/DownloadPartCore;->mIsUseHistoryTopSpeedIp:Z
...
.method private enterDonwload(Lcom/netease/ntunisdk/okhttp3/Request$Builder;Ljava/util/Map;)I
    ...
    invoke-virtual {p1, p2, v3}, Lcom/netease/ntunisdk/okhttp3/Request$Builder;->addHeader(Ljava/lang/String;Ljava/lang/String;)Lcom/netease/ntunisdk/okhttp3/Request$Builder;
...
.method private getContentLength(Ljava/util/Map;)J
    ...
    .line 869
    :goto_15
    const-string v2, "DownloadPartCore [getContentLength] 分片="
