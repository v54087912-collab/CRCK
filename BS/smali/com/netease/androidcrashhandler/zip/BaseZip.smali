...
.method private checkAndRebuildDiFile()V
    ...
    .line 220
    const-string v0, "ZipCore [checkAndRebuildDiFile] start"
    ...
    .line 229
    :cond_26
    iget-object v0, p0, Lcom/netease/androidcrashhandler/zip/BaseZip;->mDiFileName:Ljava/lang/String;
    ...
    .line 231
    iget-boolean v0, p0, Lcom/netease/androidcrashhandler/zip/BaseZip;->mIsLaunchMode:Z

    if-eqz v0, :cond_35

    .line 232
    sget-object v0, Lcom/netease/androidcrashhandler/entity/di/DiInfo;->sPreFileName:Ljava/lang/String;
...
.method private createUploadParamFile(Ljava/lang/String;Ljava/lang/String;Lorg/json/JSONObject;)V
    .registers 8
    ...
    move-result v1
    :try_end_1d
    .catchall {:try_start_e .. :try_end_1d} :catchall_5f

    const/4 v2, 0x0

    const-string/jumbo v3, "zip_upload_url"
    ...
    :cond_40
    :goto_40
    invoke-static {p3}, Lcom/netease/androidcrashhandler/util/CUtil;->checkConfigUnisecHardened(Lorg/json/JSONObject;)Z
    ...
    invoke-static {v1, p2, v2}, Lcom/netease/androidcrashhandler/util/CUtil;->str2File(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z

    .line 213
    :cond_83
    new-instance p2, Ljava/lang/StringBuilder;

    const-string v1, "ZipCore [createUploadParamFile] paramJson: "
    ...
    invoke-static {p3, p2}, Lcom/netease/androidcrashhandler/util/LogUtils;->i(Ljava/lang/String;Ljava/lang/String;)V

    .line 215
    new-instance p2, Ljava/lang/StringBuilder;

    const-string v1, "ZipCore [createUploadParamFile] cfg file="
...
.method public zipFile(Ljava/lang/String;)Ljava/lang/String;
    .registers 7
    ...
    invoke-static {v3, v4, p1, v2}, Lcom/netease/androidcrashhandler/zip/ZipUtil;->zip(Ljava/lang/String;Ljava/util/ArrayList;Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-direct {p0, v2, p1, v3}, Lcom/netease/androidcrashhandler/zip/BaseZip;->createUploadParamFile(Ljava/lang/String;Ljava/lang/String;Lorg/json/JSONObject;)V
    ...
    .line 162
    :cond_45
    const-string p1, "ZipCore [zipFile] finish"
    ...
    const-string v3, "ZipCore [zipFile] "
