...
.class public Lcom/netease/glide/load/resource/drawable/ResourceDrawableDecoder;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/netease/glide/load/resource/drawable/ResourceDrawableDecoder;->context:Landroid/content/Context;
...
.method private findContextForPackage(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;
    ...
    .line 72
    iget-object v0, p0, Lcom/netease/glide/load/resource/drawable/ResourceDrawableDecoder;->context:Landroid/content/Context;
    ...
    .line 73
    iget-object p1, p0, Lcom/netease/glide/load/resource/drawable/ResourceDrawableDecoder;->context:Landroid/content/Context;
    ...
    .line 80
    iget-object v1, p0, Lcom/netease/glide/load/resource/drawable/ResourceDrawableDecoder;->context:Landroid/content/Context;
...
.method private findResourceIdFromUri(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    .line 93
    invoke-direct {p0, p1, p2}, Lcom/netease/glide/load/resource/drawable/ResourceDrawableDecoder;->findResourceIdFromTypeAndNameResourceUri(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    .line 95
    invoke-direct {p0, p2}, Lcom/netease/glide/load/resource/drawable/ResourceDrawableDecoder;->findResourceIdFromResourceIdUri(Landroid/net/Uri;)I
...
.method public decode(Landroid/net/Uri;IILcom/netease/glide/load/Options;)Lcom/netease/glide/load/engine/Resource;
    ...
    .line 62
    invoke-direct {p0, p1, p2}, Lcom/netease/glide/load/resource/drawable/ResourceDrawableDecoder;->findContextForPackage(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;

    move-result-object p2

    .line 63
    invoke-direct {p0, p2, p1}, Lcom/netease/glide/load/resource/drawable/ResourceDrawableDecoder;->findResourceIdFromUri(Landroid/content/Context;Landroid/net/Uri;)I

    move-result p1

    .line 65
    iget-object p3, p0, Lcom/netease/glide/load/resource/drawable/ResourceDrawableDecoder;->context:Landroid/content/Context;

    invoke-static {p3, p2, p1}, Lcom/netease/glide/load/resource/drawable/DrawableDecoderCompat;->getDrawable(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    .line 66
    invoke-static {p1}, Lcom/netease/glide/load/resource/drawable/NonOwnedDrawableResource;->newInstance(Landroid/graphics/drawable/Drawable;)Lcom/netease/glide/load/engine/Resource;
...
.method public bridge synthetic decode(Ljava/lang/Object;IILcom/netease/glide/load/Options;)Lcom/netease/glide/load/engine/Resource;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/netease/glide/load/resource/drawable/ResourceDrawableDecoder;->decode(Landroid/net/Uri;IILcom/netease/glide/load/Options;)Lcom/netease/glide/load/engine/Resource;
...
.method public bridge synthetic handles(Ljava/lang/Object;Lcom/netease/glide/load/Options;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lcom/netease/glide/load/resource/drawable/ResourceDrawableDecoder;->handles(Landroid/net/Uri;Lcom/netease/glide/load/Options;)Z
