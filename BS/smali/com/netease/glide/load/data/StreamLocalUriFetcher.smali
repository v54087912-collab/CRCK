...
.class public Lcom/netease/glide/load/data/StreamLocalUriFetcher;
.super Lcom/netease/glide/load/data/LocalUriFetcher;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        "Lcom/netease/glide/load/data/LocalUriFetcher<",
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/netease/glide/load/data/StreamLocalUriFetcher;->URI_MATCHER:Landroid/content/UriMatcher;

    .line 35
    sget-object v0, Lcom/netease/glide/load/data/StreamLocalUriFetcher;->URI_MATCHER:Landroid/content/UriMatcher;
...
.method public constructor <init>(Landroid/content/ContentResolver;Landroid/net/Uri;)V
    ...
    .line 44
    invoke-direct {p0, p1, p2}, Lcom/netease/glide/load/data/LocalUriFetcher;-><init>(Landroid/content/ContentResolver;Landroid/net/Uri;)V
...
.method private loadResourceFromUri(Landroid/net/Uri;Landroid/content/ContentResolver;)Ljava/io/InputStream;
    ...
    .line 61
    :cond_14
    invoke-direct {p0, p2, p1}, Lcom/netease/glide/load/data/StreamLocalUriFetcher;->openContactPhotoInputStream(Landroid/content/ContentResolver;Landroid/net/Uri;)Ljava/io/InputStream;
...
.method protected bridge synthetic close(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/netease/glide/load/data/StreamLocalUriFetcher;->close(Ljava/io/InputStream;)V
...
.method protected loadResource(Landroid/net/Uri;Landroid/content/ContentResolver;)Ljava/io/InputStream;
    ...
    .line 50
    invoke-direct {p0, p1, p2}, Lcom/netease/glide/load/data/StreamLocalUriFetcher;->loadResourceFromUri(Landroid/net/Uri;Landroid/content/ContentResolver;)Ljava/io/InputStream;
...
.method protected bridge synthetic loadResource(Landroid/net/Uri;Landroid/content/ContentResolver;)Ljava/lang/Object;
    ...
    .line 13
    invoke-virtual {p0, p1, p2}, Lcom/netease/glide/load/data/StreamLocalUriFetcher;->loadResource(Landroid/net/Uri;Landroid/content/ContentResolver;)Ljava/io/InputStream;
