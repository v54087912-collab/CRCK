...
.method private checkExpire()Z
    ...
    move-result-wide v1
    :try_end_19
    .catch Ljava/lang/Exception; {:try_start_15 .. :try_end_19} :catch_1e
...
.method private qos()I
    ...
    .line 316
    const-string v0, "QosCore [qos] 发起qos加速"
...
.method private setTestData()Lorg/json/JSONObject;
    ...
    :try_end_5f
    .catch Ljava/lang/Exception; {:try_start_9 .. :try_end_5f} :catch_5f
...
.method public init(Lorg/json/JSONObject;)V
    ...
    invoke-virtual {p1, v1, v2}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    :try_end_90
    .catch Lorg/json/JSONException; {:try_start_72 .. :try_end_90} :catch_91
...
.method public qos_post(Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 446
    const-string/jumbo v0, "发起 QOS 加速"
    ...
    const-string/jumbo v1, "发起 QOS 加速---参数 info="
    ...
    const-string/jumbo v2, "发起 QOS 加速---处理后的url="
    ...
    move-result p1
    :try_end_79
    .catch Ljava/io/IOException; {:try_start_6b .. :try_end_79} :catch_7a
    ...
    const-string/jumbo v0, "发起 QOS 加速 [qos_post] IOException="
    ...
    const-string/jumbo v0, "发起 QOS 加速---结果="
    ...
    :cond_a2
    :goto_a2
    const-string/jumbo p1, "发起 QOS 加速---参数错误"
...
.method public start(Ljava/lang/String;)I
    ...
    const-string/jumbo v1, "获取手机号码 url="
    ...
    .line 713
    const-string/jumbo p1, "获取手机号码 参数错误"
    ...
    const-string/jumbo v2, "获取手机号码  普通请求结果="
    ...
    .line 721
    const-string/jumbo v0, "不支持HTTPDNS"
...
.method public start(Ljava/lang/String;Ljava/lang/String;)I
    ...
    iget-object v1, p0, Lcom/netease/pharos/qos/QosCore;->dealer:Lcom/netease/pharos/network/NetworkDealer;
    ...
    move-result p1
    :try_end_2b
    .catch Ljava/io/IOException; {:try_start_1c .. :try_end_2b} :catch_2c
    ...
    const-string/jumbo v0, "获取手机号码---结果="
