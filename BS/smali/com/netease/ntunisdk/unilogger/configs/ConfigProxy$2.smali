...
.method public onNetCallback(ILjava/lang/String;)V
    ...
    const-string v0, "ConfigProxy [requestRemoteConfig] ConfigRequest [onNetCallback] remoteConfig write to file, result="

    const-string v1, "ConfigProxy [requestRemoteConfig] ConfigRequest [onNetCallback] Exception="

    const-string v2, "ConfigProxy [requestRemoteConfig] ConfigRequest [onNetCallback] code="
    ...
    :try_end_1e
    .catchall {:try_start_7 .. :try_end_1e} :catchall_c9
    ...
    const-string/jumbo v2, "unilogger_local_config_file"

    invoke-static {p2, p1, v2}, Lcom/netease/ntunisdk/unilogger/utils/Utils;->str2File(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string/jumbo p1, "unilogger_local_config_file"
    ...
    invoke-virtual {p2, p1, v0, v2}, Lcom/netease/ntunisdk/unilogger/configs/Config;->parseConfig(Lorg/json/JSONObject;Lcom/netease/ntunisdk/unilogger/configs/ConfigCallBack;Z)V
    ...
    const-string/jumbo p2, "unilogger_local_config_file"

    invoke-static {p1, p2}, Lcom/netease/ntunisdk/unilogger/utils/Utils;->deleteFile(Ljava/lang/String;Ljava/lang/String;)Z
    :try_end_8c
    .catch Ljava/lang/Exception; {:try_start_22 .. :try_end_8c} :catch_8d
    .catchall {:try_start_22 .. :try_end_8c} :catchall_c9
    ...
    monitor-exit p0
    :try_end_cb
    .catchall {:try_start_8e .. :try_end_cb} :catchall_c9
