...
.method private K(Landroid/view/View;Lcom/google/android/material/transformation/FabTransformationBehavior$e;Lu5/i;Lu5/i;FFFFLandroid/graphics/RectF;)V
    .registers 10

    invoke-direct {p0, p2, p3, p5, p7}, Lcom/google/android/material/transformation/FabTransformationBehavior;->P(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Lu5/i;FF)F

    move-result p3

    invoke-direct {p0, p2, p4, p6, p8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->P(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Lu5/i;FF)F
...
.method private L(Landroid/view/View;Landroid/view/View;Lu5/j;)F
    .registers 6
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->N(Landroid/view/View;Landroid/view/View;Lu5/j;)F
...
.method private M(Landroid/view/View;Landroid/view/View;Lu5/j;)F
    .registers 6
    ...
    invoke-direct {p0, p1, p2, p3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->O(Landroid/view/View;Landroid/view/View;Lu5/j;)F
...
.method private N(Landroid/view/View;Landroid/view/View;Lu5/j;)F
    .registers 6
...
.method private O(Landroid/view/View;Landroid/view/View;Lu5/j;)F
    .registers 6
...
.method private P(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Lu5/i;FF)F
    .registers 13

    invoke-virtual {p2}, Lu5/i;->c()J

    move-result-wide v0

    invoke-virtual {p2}, Lu5/i;->d()J

    move-result-wide v2

    iget-object p1, p1, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Lu5/h;

    const-string v4, "expansion"

    invoke-virtual {p1, v4}, Lu5/h;->e(Ljava/lang/String;)Lu5/i;

    move-result-object p1

    invoke-virtual {p1}, Lu5/i;->c()J

    move-result-wide v4

    invoke-virtual {p1}, Lu5/i;->d()J
    ...
    invoke-virtual {p2}, Lu5/i;->e()Landroid/animation/TimeInterpolator;
    ...
    invoke-static {p3, p4, p1}, Lu5/a;->a(FFF)F
...
.method private R(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    sget-object p3, Lu5/d;->a:Landroid/util/Property;
    ...
    :goto_3c
    iget-object p2, p5, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Lu5/h;

    const-string p3, "contentFade"

    invoke-virtual {p2, p3}, Lu5/h;->e(Ljava/lang/String;)Lu5/i;

    move-result-object p2

    invoke-virtual {p2, p1}, Lu5/i;->a(Landroid/animation/Animator;)V
...
.method private S(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-interface {p2, p1}, Lv5/d;->setCircularRevealScrimColor(I)V

    :cond_16
    sget-object p1, Lv5/d$d;->a:Landroid/util/Property;
    ...
    :cond_21
    sget-object p3, Lv5/d$d;->a:Landroid/util/Property;
...
.method private T(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-static {p2}, Landroidx/core/view/L;->s(Landroid/view/View;)F

    move-result v1

    invoke-static {p1}, Landroidx/core/view/L;->s(Landroid/view/View;)F
...
.method private U(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;FFLjava/util/List;Ljava/util/List;)V
    ...
    iget-object v1, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Lu5/j;

    invoke-direct {v12, v0, v8, v1}, Lcom/google/android/material/transformation/FabTransformationBehavior;->L(Landroid/view/View;Landroid/view/View;Lu5/j;)F

    move-result v1

    iget-object v2, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Lu5/j;

    invoke-direct {v12, v0, v8, v2}, Lcom/google/android/material/transformation/FabTransformationBehavior;->M(Landroid/view/View;Landroid/view/View;Lu5/j;)F
    ...
    iget-object v0, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Lu5/h;

    const-string v2, "expansion"

    invoke-virtual {v0, v2}, Lu5/h;->e(Ljava/lang/String;)Lu5/i;
    ...
    invoke-direct {v0, v1, v10, v11}, Lv5/d$e;-><init>(FFF)V

    invoke-interface {v13, v0}, Lv5/d;->setRevealInfo(Lv5/d$e;)V

    :cond_42
    if-eqz p4, :cond_4b

    invoke-interface {v13}, Lv5/d;->getRevealInfo()Lv5/d$e;

    move-result-object v0

    iget v0, v0, Lv5/d$e;->c:F
    ...
    invoke-static/range {v2 .. v7}, Ly5/a;->b(FFFFFF)F

    move-result v0

    invoke-static {v13, v1, v10, v0}, Lv5/a;->a(Lv5/d;FFF)Landroid/animation/Animator;

    move-result-object v9

    new-instance v0, Lcom/google/android/material/transformation/FabTransformationBehavior$d;

    invoke-direct {v0, v12, v13}, Lcom/google/android/material/transformation/FabTransformationBehavior$d;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Lv5/d;)V

    invoke-virtual {v9, v0}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    invoke-virtual {v14}, Lu5/i;->c()J
    ...
    iget v6, v0, Lv5/d$e;->c:F

    invoke-static {v13, v1, v10, v11}, Lv5/a;->a(Lv5/d;FFF)Landroid/animation/Animator;
    ...
    invoke-virtual {v14}, Lu5/i;->d()J

    move-result-wide v4

    iget-object v0, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Lu5/h;

    invoke-virtual {v0}, Lu5/h;->f()J
    ...
    :goto_ab
    invoke-virtual {v14, v9}, Lu5/i;->a(Landroid/animation/Animator;)V

    move-object/from16 v0, p8

    invoke-interface {v0, v9}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-static {v13}, Lv5/a;->b(Lv5/d;)Landroid/animation/Animator$AnimatorListener;
...
.method private V(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    :cond_21
    sget-object p3, Lu5/e;->b:Landroid/util/Property;
    ...
    invoke-virtual {p2, p4}, Lu5/h;->e(Ljava/lang/String;)Lu5/i;

    move-result-object p2

    invoke-virtual {p2, p3}, Lu5/i;->a(Landroid/animation/Animator;)V

    invoke-interface {p6, p3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance p2, Lcom/google/android/material/transformation/FabTransformationBehavior$c;

    invoke-direct {p2, p0, v0, p1}, Lcom/google/android/material/transformation/FabTransformationBehavior$c;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Lv5/d;Landroid/graphics/drawable/Drawable;)V
...
.method private Y(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;Landroid/graphics/RectF;)V
    ...
    iget-object v5, v2, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Lu5/j;

    invoke-direct {v10, v0, v1, v5}, Lcom/google/android/material/transformation/FabTransformationBehavior;->N(Landroid/view/View;Landroid/view/View;Lu5/j;)F

    move-result v5

    iget-object v6, v2, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Lu5/j;

    invoke-direct {v10, v0, v1, v6}, Lcom/google/android/material/transformation/FabTransformationBehavior;->O(Landroid/view/View;Landroid/view/View;Lu5/j;)F
    ...
    :cond_2c
    iget-object v7, v2, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Lu5/h;

    const-string v8, "translationXCurveUpwards"

    invoke-virtual {v7, v8}, Lu5/h;->e(Ljava/lang/String;)Lu5/i;

    move-result-object v7

    iget-object v8, v2, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Lu5/h;

    const-string v9, "translationYCurveUpwards"

    invoke-virtual {v8, v9}, Lu5/h;->e(Ljava/lang/String;)Lu5/i;
    ...
    invoke-direct/range {v0 .. v9}, Lcom/google/android/material/transformation/FabTransformationBehavior;->K(Landroid/view/View;Lcom/google/android/material/transformation/FabTransformationBehavior$e;Lu5/i;Lu5/i;FFFFLandroid/graphics/RectF;)V
    ...
    :goto_a9
    invoke-virtual {v12, v14}, Lu5/i;->a(Landroid/animation/Animator;)V

    invoke-virtual {v13, v15}, Lu5/i;->a(Landroid/animation/Animator;)V
...
.method private Z(Landroid/view/View;)I
    ...
    invoke-static {p1}, Landroidx/core/view/L;->o(Landroid/view/View;)Landroid/content/res/ColorStateList;
...
.method protected I(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    invoke-static {v0, v13}, Lu5/b;->a(Landroid/animation/AnimatorSet;Ljava/util/List;)V
