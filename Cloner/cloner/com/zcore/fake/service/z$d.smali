.class public Lcom/zcore/fake/service/z$d;
.super Lp5/d;
.source "SourceFile"
...
.method private f(Ljava/lang/String;)Landroid/app/job/JobInfo;
    ...
    .line 3
    const-string v1, "Schedule: Creating minimal JobInfo for work ID: "
    ...
    .line 24
    const-string v1, "Schedule: Failed to create minimal JobInfo"
...
.method private g(Ljava/lang/Object;Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;
    .registers 10
    ...
    .line 3
    const-string v1, "Schedule: Handling WorkManager string ID: "
    ...
    .line 30
    invoke-direct {p0, v4}, Lcom/zcore/fake/service/z$d;->f(Ljava/lang/String;)Landroid/app/job/JobInfo;
    ...
    move-result-object p1
    :try_end_30
    .catch Ljava/lang/Exception; {:try_start_6 .. :try_end_30} :catch_2a
    ...
    .line 50
    :goto_31
    const-string p2, "Schedule: Failed to handle non-JobInfo schedule"
    ...
    .line 55
    invoke-direct {p0, p1}, Lcom/zcore/fake/service/z$d;->h(Ljava/lang/Exception;)Z
    ...
    .line 61
    const-string p1, "Schedule: Suppressing UID validation error for non-JobInfo, returning fake success"
...
.method private h(Ljava/lang/Exception;)Z
    .registers 6
...
.method private i(Ljava/lang/Object;Ljava/lang/reflect/Method;[Ljava/lang/Object;Landroid/app/job/JobInfo;)Ljava/lang/Object;
    .registers 9

    .line 1
    const-string v0, "job_schedule"

    .line 3
    const-string v1, "JobServiceStub"

    .line 5
    const-string v2, "Schedule: Attempting UID spoofing for package: "
    ...
    .line 40
    const-string p1, "Schedule: UID spoofing needed, attempting to bypass validation"

    .line 42
    invoke-static {v3, v1, p1}, Landroid/util/Log;->println(ILjava/lang/String;Ljava/lang/String;)I

    .line 45
    const-string p1, "Schedule: UID spoofing not fully implemented, returning RESULT_SUCCESS (fake)"
    ...
    .line 59
    :cond_3a
    const-string p4, "Schedule: No UID spoofing needed, proceeding normally"

    .line 61
    invoke-static {v3, v1, p4}, Landroid/util/Log;->println(ILjava/lang/String;Ljava/lang/String;)I
    ...
    move-result-object p1
    :try_end_43
    .catch Ljava/lang/Exception; {:try_start_6 .. :try_end_43} :catch_38
    ...
    .line 69
    :goto_44
    const-string p2, "Schedule: UID spoofing failed"
...
.method public d(Ljava/lang/Object;Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 1
    const-string v0, "Schedule: Processing JobInfo for package: "

    .line 3
    const-string v1, "Schedule: args[0] is not JobInfo: "
    ...
    .line 20
    const-string v0, "Schedule: args[0] is null, returning RESULT_FAILURE"
    ...
    .line 51
    invoke-direct {p0, p1, p2, p3}, Lcom/zcore/fake/service/z$d;->g(Ljava/lang/Object;Ljava/lang/reflect/Method;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 113
    const-string v0, "Schedule: Successfully created proxy JobInfo"
    ...
    .line 124
    :try_start_7b
    const-string v1, "Schedule: BlackBox job manager failed, trying system fallback"
    ...
    .line 129
    :cond_80
    invoke-direct {p0, p1, p2, p3, v5}, Lcom/zcore/fake/service/z$d;->i(Ljava/lang/Object;Ljava/lang/reflect/Method;[Ljava/lang/Object;Landroid/app/job/JobInfo;)Ljava/lang/Object;
    ...
    :cond_85
    :goto_85
    const-string v0, "Schedule: No arguments provided, returning RESULT_FAILURE"
    ...
    .line 144
    :goto_8f
    const-string v1, "Schedule: Error processing job"
    ...
    .line 149
    invoke-direct {p0, v0}, Lcom/zcore/fake/service/z$d;->h(Ljava/lang/Exception;)Z
    ...
    .line 157
    const-string p2, "UID validation failed for job scheduling, returning RESULT_FAILURE: "
    ...
    .line 191
    const-string p2, "Schedule: Fallback also failed"
