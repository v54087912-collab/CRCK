...
.method private final getProviderInstance(Ljava/lang/String;Ljava/lang/ClassLoader;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    const-string v0, "2B081D040D150201521D151F17070202451D08500E0D0F121445"
    ...
    const-string p3, "42500F141A41010A0700144D"
...
.method private final parse(Ljava/net/URL;)Ljava/util/List;
    ...
    const-string p1, "04111F5B08080B0048"
    ...
    :try_end_4f
    .catchall {:try_start_32 .. :try_end_4f} :catchall_66
    ...
    move-result-object v0
    :try_end_58
    .catchall {:try_start_4f .. :try_end_58} :catchall_5f
...
.method private final parseFile(Ljava/io/BufferedReader;)Ljava/util/List;
    ...
    const-string v0, "271C010409000B45010B021B080D04471500010604050B1347061E0F031E4100000A00484E"
...
.method public final loadMainDispatcherFactory$kotlinx_coroutines_core()Ljava/util/List;
    ...
    const-string v2, "051F190D070F1F4B11010202141A08090001401103051C0E0E015C2F1E0913010803211B1D000C150D090217340F13190E1C18"

    invoke-static {v2}, Lobfuse/NPStringFog;->decode(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2
    :try_end_1d
    .catchall {:try_start_11 .. :try_end_1d} :catchall_6d
    ...
    :try_end_3a
    .catch Ljava/lang/ClassNotFoundException; {:try_start_20 .. :try_end_3a} :catch_3b
    .catchall {:try_start_20 .. :try_end_3a} :catchall_6d
    ...
    :cond_42
    const-string v2, "051F190D070F1F4B11010202141A08090001400408121A4F0E0B060B020300024F3300011A3D0C0800250E16020F040E090B132104111A1F1F18"
    ...
    check-cast v2, Lkotlinx/coroutines/internal/MainDispatcherFactory;
    :try_end_62
    .catch Ljava/lang/ClassNotFoundException; {:try_start_48 .. :try_end_62} :catch_64
    .catchall {:try_start_48 .. :try_end_62} :catchall_6d
...
.method public final loadProviders$kotlinx_coroutines_core(Ljava/lang/Class;Ljava/lang/ClassLoader;)Ljava/util/List;
    ...
    const-string v1, "23353920432829235D1D151F17070202165D"
    ...
    const-string v1, "02191E1546150F0C0147"
    ...
    const-string p2, "201F4D111C0E110C160B021E411904150052021F0C050B0547121B1A184D270F121336171C0604020B2D0804160B02"
