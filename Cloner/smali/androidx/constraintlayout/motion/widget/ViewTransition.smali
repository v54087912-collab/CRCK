...
.method constructor <init>(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    move-result v2
    :try_end_2a
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_26 .. :try_end_2a} :catch_103
    .catch Ljava/io/IOException; {:try_start_26 .. :try_end_2a} :catch_fe
    ...
    const-string v4, "381908163A13060B010704040E00"
    ...
    sparse-switch v7, :sswitch_data_108

    goto :goto_93

    :sswitch_53
    const-string v4, "2D051E15010C2611061C190F141A04"
    ...
    :sswitch_61
    const-string v4, "2D051E15010C2A0006061F09"
    ...
    :sswitch_77
    const-string v4, "251514271C000A00210B04"
    ...
    :sswitch_85
    const-string v4, "2D1F03121A13060C1C1A3F1B041C130E0117"
    ...
    const-string v5, "4E05030A000E100B521A110A41"
    ...
    move-result v2
    :try_end_fc
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_3b .. :try_end_fc} :catch_103
    .catch Ljava/io/IOException; {:try_start_3b .. :try_end_fc} :catch_fe
    ...
    :sswitch_data_108
    .sparse-switch
        -0x74f4db17 -> :sswitch_85
        -0x49df9cec -> :sswitch_77
        0x3b205fa -> :sswitch_6f
        0x15d883d2 -> :sswitch_61
        0x6acd460b -> :sswitch_53
    .end sparse-switch
.end method
...
.method public toString()Ljava/lang/String;
    ...
    const-string v1, "381908163A13060B010704040E0049"
